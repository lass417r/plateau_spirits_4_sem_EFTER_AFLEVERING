...
function Historie() {
  return (
    <div className="flex flex-col items-start gap-5 p-5 md:ml-20 ">
      <h2 className="font-tyk text-wh2 lg:pt-28">Vores historie</h2>
      ...
      <p className="pt-5 font-tyk text-wh6 lg:max-w-[80%]">
